...
//http的api，目前主要是ssh的websocket
  ...
  static final String mdnsTypeExplorer = '_services._dns-sd._udp.local';

  static final String mdnsBaseTcpService = '_tcp.local.';
  static final String mdnsBaseUdpService = '_udp.local.';

  static final String mdnsIoTDeviceService = '_iotdevice._tcp.local';
  static final String mdnsGatewayService = '_openiothub-gateway._tcp.local';
}
